...
//	ProductDAO productDAO;
	...
	@PostMapping() // url - localhost:9090/product - Post
	public ResponseEntity<String> saveProduct(@RequestBody Product product) {
//		return productService.saveProduct(product);// save product in DB
//		return "Saving the product with Details " + product; 
	...
	@GetMapping // url - localhost:9090/product
	public  ResponseEntity<List<Product>> getProducts() {
		...
		return responseEntity;
//		return (List<Product>) productDAO.findAll();//get all product
//		return "Getting all products";
	...
	@DeleteMapping("{productId}") // url - localhost:9090/product/2435678
	...
	@PutMapping() // url - localhost:9090/product - Put
